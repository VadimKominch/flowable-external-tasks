...
@ExternalTask(topic = "optional-job-worker-2-topic")
public class OptionalWorkerTwoJobWorker extends AbstractTask {

    public OptionalWorkerTwoJobWorker(ProcessClientService processService) {
        super(processService);
    }

    @Override
    public List<ProcessInstanceVariable> execute(JobDto job) {
        System.out.println("Optional worker 2");
        return List.of();
    }
}
